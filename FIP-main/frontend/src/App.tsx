...
type Section =
  ...
  | 'chat' | 'cases' | 'behavioral' | 'storyline' | 'ml-settings'
...
export default function App() {
  ...
  const nav = {
    ...
    behavioral: <Icon d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />,
    ...
    <div className="flex h-screen bg-gray-950 overflow-hidden">
      ...
      <aside className="w-56 flex-shrink-0 flex flex-col bg-slate-900 border-r border-slate-800">
        ...
        <nav className="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto">
          ...
          <NavItem id="behavioral"   label="Behavioral"       active={activeSection === 'behavioral'}   onClick={switchSection} icon={nav.behavioral} />

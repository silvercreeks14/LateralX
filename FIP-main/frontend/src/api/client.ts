...
export type { NarrativeCitation, BehavioralReport, BehavioralAnomaly, AttackStoryline, AttackStep, LateralPath, BlastRadius }
...
export const api = {
  ...
  verifyMlPrediction: (user: string, isPositive: boolean, notes?: string): Promise<object> =>
    request('/ml/verify', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ user, is_true_positive: isPositive, notes }),
    }),
